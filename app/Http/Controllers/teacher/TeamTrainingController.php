...
class TeamTrainingController extends Controller
{
    public function index()
    {
        ...
        return view('teacher.team_training.index', $page_data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('teacher.team_training.edit', $page_data);
    }
    ...
    public function duplicate($id)
    {
        ...
        return to_route('teacher.team.packages.edit', $insert_id)->with('success', get_phrase('Package has been copied.'));
    }
    ...
    public function get_courses(Request $request)
    {
        if (isset($request->privacy) && in_array($request->privacy, ['public', 'private'])) {
            ...
            return view('teacher.team_training.load_courses', compact('courses'));
        }
    }
    ...
    public function purchase_history()
    {
        ...
        return view('teacher.team_training.purchase_history', $page_data);
    }
    ...
    public function invoice($id)
    {
        ...
        return view('teacher.team_training.invoice', $page_data);
    }
}
