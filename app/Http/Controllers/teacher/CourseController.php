...
class CourseController extends Controller
{
    public function index(Request $request)
    {
        ...
        if (isset($_GET['teacher']) && $_GET['teacher'] != '' && $_GET['teacher'] != 'all') {
            $query      = $query->where('user_id', $_GET['teacher']);
        ...
        return view('teacher.course.index', $page_data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $data['teachers'] = json_encode($request->teachers);
        ...
        return [
            'redirectTo' => route('teacher.course.edit', ['id' => $course_id]),
        ];
    }
    ...
    public function delete($id)
    {
        ...
        remove_file($query->first()->preview);
        $query->delete();
        return redirect(route('teacher.courses'))->with('success', get_phrase('Course deleted successfully'));
    }
    ...
    public function duplicate($id)
    {
        ...
        return redirect()->route('teacher.course.edit', $course_id);
    }
}
