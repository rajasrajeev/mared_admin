...
class BlogController extends Controller
{
    public function index()
    {
        ...
        return view("teacher.blog.index", $page_data);
    }

    public function create()
    {
        $page_data["category"] = BlogCategory::all();
        return view("teacher.blog.create", $page_data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('teacher.blogs');
    }
    ...
    public function edit($id)
    {
        ...
        $page_data["category"]  = BlogCategory::all();
        return view("teacher.blog.edit", $page_data);
    }
    ...
    public function pending()
    {
        ...
        $page_data["blogs"] = $query->paginate(10)->appends(request()->query());
        return view("teacher.blog.pending", $page_data);
    }
}
