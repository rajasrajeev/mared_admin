...
class BootcampController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->has('teacher') && request()->query('teacher') != 'all') {
            $query = $query->where('bootcamps.user_id', request()->query('teacher'));
        }
        ...
        return view('teacher.bootcamp.index', $page_data);
    }

    public function create()
    {
        return view('teacher.bootcamp.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('teacher.bootcamp.edit', [$insert_id, 'tab' => 'curriculum']);
    }
    ...
    public function duplicate($id)
    {
        ...
        return redirect()->route('teacher.bootcamp.edit', [$insert_id, 'tab' => 'basic']);
    }
    ...
    public function purchase_history()
    {
        ...
        return view('teacher.bootcamp.purchase_history', $page_data);
    }
    ...
    public function invoice($id)
    {
        ...
        return view('teacher.bootcamp.invoice', $page_data);
    }
}
