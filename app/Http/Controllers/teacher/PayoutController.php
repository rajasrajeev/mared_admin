...
// modify date and prepare to compare with database
        ...
        $page_data['total_payout']   = teacher_total_payout();
        $page_data['balance']        = teacher_available_balance();

        return view('teacher.payout_report.index', $page_data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $total_income      = teacher_total_revenue();
        $total_payout      = teacher_total_payout();
