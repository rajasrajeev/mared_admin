...
class BlogController extends Controller
{
    public function index()
    {
        ...
        return view("supervisor.blog.index", $page_data);
    }

    public function create()
    {
        $page_data["category"] = BlogCategory::all();
        return view("supervisor.blog.create", $page_data);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('supervisor.blogs');
    }
    ...
    public function edit($id)
    {
        ...
        $page_data["category"]  = BlogCategory::all();
        return view("supervisor.blog.edit", $page_data);
    }
    ...
    public function pending()
    {
        ...
        $page_data["blogs"] = $query->paginate(10)->appends(request()->query());
        return view("supervisor.blog.pending", $page_data);
    }
}
