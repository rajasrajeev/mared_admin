...
class CourseController extends Controller
{
    public function index(Request $request)
    {
        ...
        // selected supervisor
        if (isset($_GET['supervisor']) && $_GET['supervisor'] != '' && $_GET['supervisor'] != 'all') {
            $query      = $query->where('user_id', $_GET['supervisor']);
        ...
        $page_data['supervisor']       = $supervisor;
        ...
        return view('supervisor.course.index', $page_data);
    }

    public function create()
    {
        return view('supervisor.course.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return [
            'redirectTo' => route('supervisor.course.edit', ['id' => $course_id]),
        ];
    }
    ...
    public function edit($course_id = "", Request $request)
    {
        ...
        return view('supervisor.course.edit', $data);
    }
    ...
    public function delete($id)
    {
        ...
        remove_file($query->first()->preview);
        $query->delete();
        return redirect(route('supervisor.courses'))->with('success', get_phrase('Course deleted successfully'));
    }
    ...
    public function duplicate($id)
    {
        ...
        return redirect()->route('supervisor.course.edit', $course_id);
    }
}
