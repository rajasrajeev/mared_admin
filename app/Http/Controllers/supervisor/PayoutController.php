...
// modify date and prepare to compare with database
        ...
        $page_data['total_payout']   = supervisor_total_payout();
        $page_data['balance']        = supervisor_available_balance();

        return view('supervisor.payout_report.index', $page_data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $total_income      = supervisor_total_revenue();
        $total_payout      = supervisor_total_payout();
