...
class PayoutSettingsController extends Controller {
    public function payout_setting() {
        ...
        $page_data['supervisor'] = json_decode($payment_setting->paymentkeys, true);
        return view('supervisor.payout_setting.index', $page_data);
    }
    ...
    public function payout_setting_store(Request $request) {
        ...
        return redirect(route('supervisor.payout.setting'))->with('success', get_phrase('Payout setting updated'));
    }
}
