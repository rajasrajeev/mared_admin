...
class BootcampController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->has('supervisor') && request()->query('supervisor') != 'all') {
            $query = $query->where('bootcamps.user_id', request()->query('supervisor'));
        }
        ...
        return view('supervisor.bootcamp.index', $page_data);
    }

    public function create()
    {
        return view('supervisor.bootcamp.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('supervisor.bootcamp.edit', [$insert_id, 'tab' => 'curriculum']);
    }
    ...
    public function duplicate($id)
    {
        ...
        return redirect()->route('supervisor.bootcamp.edit', [$insert_id, 'tab' => 'basic']);
    }
    ...
    public function purchase_history()
    {
        ...
        return view('supervisor.bootcamp.purchase_history', $page_data);
    }
    ...
    public function invoice($id)
    {
        ...
        return view('supervisor.bootcamp.invoice', $page_data);
    }
}
