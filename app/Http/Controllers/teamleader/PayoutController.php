...
// modify date and prepare to compare with database
        ...
        $page_data['total_payout']   = teamleader_total_payout();
        $page_data['balance']        = teamleader_available_balance();

        return view('teamleader.payout_report.index', $page_data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $total_income      = teamleader_total_revenue();
        $total_payout      = teamleader_total_payout();
