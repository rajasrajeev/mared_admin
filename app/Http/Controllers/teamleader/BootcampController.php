...
class BootcampController extends Controller
{
    ...
    public function index()
    {
        ...
        if (request()->has('teamleader') && request()->query('teamleader') != 'all') {
            $query = $query->where('bootcamps.user_id', request()->query('teamleader'));
        }
        ...
        return view('teamleader.bootcamp.index', $page_data);
    }

    public function create()
    {
        return view('teamleader.bootcamp.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('teamleader.bootcamp.edit', [$insert_id, 'tab' => 'curriculum']);
    }
    ...
    public function duplicate($id)
    {
        ...
        return redirect()->route('teamleader.bootcamp.edit', [$insert_id, 'tab' => 'basic']);
    }
    ...
    public function purchase_history()
    {
        ...
        return view('teamleader.bootcamp.purchase_history', $page_data);
    }
    ...
    public function invoice($id)
    {
        ...
        return view('teamleader.bootcamp.invoice', $page_data);
    }
}
