...
class BootcampLiveClassController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (array_key_exists('code', $joiningInfoArr) && $joiningInfoArr) {
            return redirect(route('teamleader.bootcamp.edit', ['id' => $module->bootcamp_id, 'tab' => 'curriculum']))->with('error', get_phrase($joiningInfoArr['message']));
        }
        $data['provider']     = 'zoom';
        ...
        return redirect()->route('teamleader.bootcamp.edit', ['id' => $module->bootcamp_id, 'tab' => 'curriculum']);
    }
