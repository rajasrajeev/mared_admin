...
class PayoutSettingsController extends Controller {
    public function payout_setting() {
        ...
        $page_data['teamleader'] = json_decode($payment_setting->paymentkeys, true);
        return view('teamleader.payout_setting.index', $page_data);
    }
    ...
    public function payout_setting_store(Request $request) {
        ...
        return redirect(route('teamleader.payout.setting'))->with('success', get_phrase('Payout setting updated'));
    }
}
