...
class CourseController extends Controller
{
    public function index(Request $request)
    {
        ...
        // selected teamleader
        if (isset($_GET['teamleader']) && $_GET['teamleader'] != '' && $_GET['teamleader'] != 'all') {
            $query      = $query->where('user_id', $_GET['teamleader']);
        ...
        $page_data['teamleader']       = $teamleader;
        ...
        return view('teamleader.course.index', $page_data);
    }

    public function create()
    {
        return view('teamleader.course.create');
    }
    ...
    public function store(Request $request)
    {
        $rules = [
            ...
            'outcomes'         => 'array',
            'faqs'             => 'array',
            'teamleaders'      => 'required|array|min:1',
        ];
        ...
        $data['teamleaders'] = json_encode($request->teamleaders);
        ...
        return [
            'redirectTo' => route('teamleader.course.edit', ['id' => $course_id]),
        ];
    }
    ...
    public function edit($course_id = "", Request $request)
    {
        ...
        return view('teamleader.course.edit', $data);
    }
    ...
    public function delete($id)
    {
        ...
        remove_file($query->first()->preview);
        $query->delete();
        return redirect(route('teamleader.courses'))->with('success', get_phrase('Course deleted successfully'));
    }
    ...
    public function duplicate($id)
    {
        ...
        return redirect()->route('teamleader.course.edit', $course_id);
    }
}
