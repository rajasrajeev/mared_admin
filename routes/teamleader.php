...
use App\Http\Controllers\teamleader\BlogController;
use App\Http\Controllers\teamleader\BootcampController;
use App\Http\Controllers\teamleader\BootcampLiveClassController;
use App\Http\Controllers\teamleader\BootcampModuleController;
use App\Http\Controllers\teamleader\BootcampResourceController;
use App\Http\Controllers\teamleader\CourseController;
use App\Http\Controllers\teamleader\DashboardController;
use App\Http\Controllers\teamleader\LessonController;
use App\Http\Controllers\teamleader\MyProfileController;
use App\Http\Controllers\teamleader\PayoutController;
use App\Http\Controllers\teamleader\PayoutSettingsController;
use App\Http\Controllers\teamleader\QuestionController;
use App\Http\Controllers\teamleader\QuizController;
use App\Http\Controllers\teamleader\SalesReportController;
use App\Http\Controllers\teamleader\SectionController;
use App\Http\Controllers\teamleader\TeamTrainingController;
use App\Http\Controllers\teamleader\OpenAiController;
...
Route::name('teamleader.')->prefix('teamleader')->middleware(['teamleader'])->group(function () {
    // dashboard
    ...
    // blog route
    Route::controller(BlogController::class)->middleware('teamleaderBlogPermission')->group(function () {
    ...
    Route::controller(TeamTrainingController::class)->group(function () {
        ...
        Route::view('team-packages/create', 'teamleader.team_training.create')->name('team.packages.create');
...
Route::get('teamleader/select-language/{language}', [LanguageController::class, 'select_lng'])->name('teamleader.select.language');
