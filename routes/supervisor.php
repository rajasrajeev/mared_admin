...
use App\Http\Controllers\supervisor\BlogController;
use App\Http\Controllers\supervisor\BootcampController;
use App\Http\Controllers\supervisor\BootcampLiveClassController;
use App\Http\Controllers\supervisor\BootcampModuleController;
use App\Http\Controllers\supervisor\BootcampResourceController;
use App\Http\Controllers\supervisor\CourseController;
use App\Http\Controllers\supervisor\DashboardController;
use App\Http\Controllers\supervisor\LessonController;
use App\Http\Controllers\supervisor\MyProfileController;
use App\Http\Controllers\supervisor\PayoutController;
use App\Http\Controllers\supervisor\PayoutSettingsController;
use App\Http\Controllers\supervisor\QuestionController;
use App\Http\Controllers\supervisor\QuizController;
use App\Http\Controllers\supervisor\SalesReportController;
use App\Http\Controllers\supervisor\SectionController;
use App\Http\Controllers\supervisor\TeamTrainingController;
use App\Http\Controllers\supervisor\OpenAiController;
...
Route::name('supervisor.')->prefix('supervisor')->middleware(['supervisor'])->group(function () {
    // dashboard
    ...
    // blog route
    Route::controller(BlogController::class)->middleware('supervisorBlogPermission')->group(function () {
    ...
    Route::controller(TeamTrainingController::class)->group(function () {
        ...
        Route::view('team-packages/create', 'supervisor.team_training.create')->name('team.packages.create');
...
Route::get('supervisor/select-language/{language}', [LanguageController::class, 'select_lng'])->name('supervisor.select.language');
