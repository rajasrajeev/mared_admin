...
use App\Http\Controllers\teacher\BlogController;
use App\Http\Controllers\teacher\BootcampController;
use App\Http\Controllers\teacher\BootcampLiveClassController;
use App\Http\Controllers\teacher\BootcampModuleController;
use App\Http\Controllers\teacher\BootcampResourceController;
...
use App\Http\Controllers\teacher\MyProfileController;
use App\Http\Controllers\teacher\PayoutController;
use App\Http\Controllers\teacher\PayoutSettingsController;
use App\Http\Controllers\teacher\QuestionController;
use App\Http\Controllers\teacher\QuizController;
use App\Http\Controllers\teacher\SalesReportController;
use App\Http\Controllers\teacher\SectionController;
use App\Http\Controllers\teacher\TeamTrainingController;
use App\Http\Controllers\teacher\OpenAiController;
...
Route::name('teacher.')->prefix('teacher')->middleware(['teacher'])->group(function () {
    ...
    // blog route
    Route::controller(BlogController::class)->middleware('teacherBlogPermission')->group(function () {
    ...
    Route::controller(TeamTrainingController::class)->group(function () {
        ...
        Route::view('team-packages/create', 'teacher.team_training.create')->name('team.packages.create');
...
Route::get('teacher/select-language/{language}', [LanguageController::class, 'select_lng'])->name('teacher.select.language');
