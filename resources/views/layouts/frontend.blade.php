...
<head>
    ...
    <!-- <link rel="icon" href="{{ asset('assets/frontend/new/images/favicon.ico') }}" type="image/x-icon"> -->
    <link rel="stylesheet" href="{{ asset('assets/frontend/new/components/base/base.css') }}">
    <script src="{{ asset('assets/frontend/new/components/base/core.min.js') }}"></script>
    <script src="{{ asset('assets/frontend/new/components/base/script.js') }}"></script>
    @stack('css')
