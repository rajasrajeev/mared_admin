            ...
            <div class="col-lg-12">
                <div class="res-control d-flex align-items-center justify-content-between">
                    <div class="section-title mb-0">
                        ...
                        <h2 class="title builder-editable" builder-identity="2">Featured Courses
                        </h2>
                    </div>
                    <span class="featured-course-all-button">
                        <a href="{{ route('courses') }}" class="eBtn gradient builder-editable" builder-identity="3">View All Courses</a>
                    </span>
                </div>
            </div>
        </div>
