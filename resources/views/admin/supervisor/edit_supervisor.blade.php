...
@push('title', get_phrase('Edit Supervisor'))
...
@section('content')
    ...
    <div class="ol-card p-4">
        ...
        <div class="ol-card-body">
            <form action="{{ route('admin.supervisor.update', ['id' => $supervisor->id]) }}" method="post" enctype="multipart/form-data">
                @csrf
