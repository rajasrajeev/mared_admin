<div class="row mb-3">
    ...
    <div class="col-sm-8">
        <input type="text" name="name" class="form-control ol-form-control" id="user-name" @isset($supervisor->name) value="{{ $supervisor->name }}" @endisset required>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-8">
        <textarea name="about" rows="3" class="form-control ol-form-control" id="short_description">@isset($supervisor->about){{ $supervisor->about }}@endisset</textarea>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-8">
        <input type="text" name="phone" class="form-control ol-form-control" id="user-phone" @isset($supervisor->phone) value="{{ $supervisor->phone }}" @endisset>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-8">
        <input type="text" name="address" class="form-control ol-form-control" id="user-address" @isset($supervisor->address) value="{{ $supervisor->address }}" @endisset>
    </div>
</div>
<div class="row mb-3">
