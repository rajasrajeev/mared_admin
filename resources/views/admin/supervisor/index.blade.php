    ...
    <div class="ol-card radius-8px">
        <div class="ol-card-body my-3 py-12px px-20px">
            <div class="d-flex align-items-center justify-content-between gap-3 flex-wrap flex-md-nowrap">
                ...
                <a href="{{ route('admin.supervisor.create') }}" class="btn ol-btn-outline-secondary d-flex align-items-center cg-10px">
    ...
    <div class="ol-card p-4">
        <div class="ol-card-body">
            ...
            <div class="row print-d-none mb-3 mt-3 row-gap-3">
                <div class="col-md-6 pt-2 pt-md-0">
                    <div class="custom-dropdown">
                        ...
                        <ul class="dropdown-list">
                            <li>
                                <a class="dropdown-item" href="#" onclick="downloadPDF('.print-table', 'supervisor-list')"><i class="fi-rr-file-pdf"></i> {{ get_phrase('PDF') }}</a>
                            </li>
                            <li>
                ...
                <div class="col-md-6">
                    <form class="form-inline" action="{{ route('admin.supervisor.index') }}" method="get">
                ...
                <div class="col-md-12">
                    ...
                    @if (count($supervisors) > 0)
                        <div class="admin-tInfo-pagi d-flex justify-content-between justify-content-center align-items-center flex-wrap gr-15">
                            <p class="admin-tInfo">
                                {{ get_phrase('Showing') . ' ' . count($supervisors) . ' ' . get_phrase('of') . ' ' . $supervisors->total() . ' ' . get_phrase('data') }}
                            </p>
                        </div>
                            ...
                            <table class="table eTable eTable-2 print-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Number of Team Leaders</th>
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ route('admin.courses', ['supervisor' => $row->id]) }}">{{ get_phrase('View courses') }}</a>
                                                        </li>

                                                        <li>
                                                            <a class="dropdown-item" href="{{ route('admin.supervisor.edit', $row->id) }}">{{ get_phrase('Edit') }}</a>
                                                        </li>

                                                        <li>
                                                            <a class="dropdown-item" onclick="confirmModal('{{ route('admin.supervisor.delete', $row->id) }}')"
