<div class="row mb-3">
    ...
    <div class="col-sm-8">
        <input type="email" name="email" class="form-control ol-form-control" id="email" @isset($teamleader->email) value="{{ $teamleader->email }}" @endisset required>
    </div>
</div>

@if(!isset($teamleader->email))
    <div class="row mb-3">
