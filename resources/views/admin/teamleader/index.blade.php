    ...
    <div class="ol-card radius-8px">
        <div class="ol-card-body my-3 py-12px px-20px">
            <div class="d-flex align-items-center justify-content-between gap-3 flex-wrap flex-md-nowrap">
                ...
                <a href="{{ route('admin.teamleader.create') }}" class="btn ol-btn-outline-secondary d-flex align-items-center cg-10px">
                    <span class="fi-rr-plus"></span>
                    <span>Add new Team Leader</span>
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="ol-card p-4">
        <div class="ol-card-body">
            ...
            <div class="row print-d-none mb-3 mt-3 row-gap-3">
                <div class="col-md-6 pt-2 pt-md-0">
                    <div class="custom-dropdown">
                        ...
                        <ul class="dropdown-list">
                            <li>
                                <a class="dropdown-item" href="#" onclick="downloadPDF('.print-table', 'teamleader-list')"><i class="fi-rr-file-pdf"></i> {{ get_phrase('PDF') }}</a>
                            </li>
                            <li>
                ...
                <div class="col-md-6">
                    <form class="form-inline" action="{{ route('admin.teamleader.index') }}" method="get">
                ...
                <div class="col-md-12">
                    ...
                    @if (count($teamleaders) > 0)
                        <div class="admin-tInfo-pagi d-flex justify-content-between justify-content-center align-items-center flex-wrap gr-15">
                            <p class="admin-tInfo">
                                {{ get_phrase('Showing') . ' ' . count($teamleaders) . ' ' . get_phrase('of') . ' ' . $teamleaders->total() . ' ' . get_phrase('data') }}
                            </p>
                        </div>
                        <div class="table-responsive course_list" id="course_list">
                            <table class="table eTable eTable-2 print-table">
                                ...
                                <tbody>
                                    @foreach ($teamleaders as $key => $row)
                                        <tr>
                                            <th scope="row">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ route('admin.courses', ['teamleader' => $row->id]) }}">{{ get_phrase('View courses') }}</a>
                                                        </li>

                                                        <li>
                                                            <a class="dropdown-item" href="{{ route('admin.teamleader.edit', $row->id) }}">{{ get_phrase('Edit') }}</a>
                                                        </li>

                                                        <li>
                                                            <a class="dropdown-item" onclick="confirmModal('{{ route('admin.teamleader.delete', $row->id) }}')"
