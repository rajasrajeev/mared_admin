                ...
                <div class="col-xl-12">
                    <div class="row justify-content-center">
                        <form action="{{ route('admin.website.settings.update') }}" method="post" enctype="multipart/form-data" class="text-center">
                                            ...
                                            <label for="banner_image" class="btn ol-card p-4-text">
                                                ...
                                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        ...
                                                        fill="#797c8b" />
                                                </svg>{{ get_phrase('Upload banner image') }}
                            ...
                            <button type="submit" class="btn ol-btn-primary w-100">{{ get_phrase('Upload banner image') }}</button>
                        </form>
                    </div>
                </div>
            </div>
                            ...
                            <div class="form-group mb-2">
                                <div class="wrapper-image-preview d-flex justify-content-center">
                                    <div class="box">
                                        ...
                                        <div class="upload-options">
                                            <label for="favicon" class="btn ol-card p-4-text"> <i class="mdi mdi-camera"></i>{{ get_phrase('Upload favicon') }}
                                                <br> <small>(90 X
                                                    90)</small> </label>
