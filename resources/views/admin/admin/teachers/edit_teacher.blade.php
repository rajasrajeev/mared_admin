...
@section('content')
    <div class="ol-card radius-8px">
        <div class="ol-card-body my-3 py-12px px-20px">
            <div class="d-flex align-items-center justify-content-between gap-3 flex-wrap flex-md-nowrap">
                ...
                <a href="{{ route('admin.admins.teachers.index') }}" class="btn ol-btn-outline-secondary d-flex align-items-center cg-10px">
    ...
    <div class="ol-card p-4">
        <h4 class="title fs-16px mb-20px">Teacher Info</h4>
        <div class="ol-card-body">
            <form action="{{ route('admin.admins.teachers.update', ['id' => $teacher->id]) }}" method="post" enctype="multipart/form-data">
                @csrf
