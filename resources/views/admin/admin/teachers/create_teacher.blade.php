...
@section('content')
    ...
    <div class="ol-card p-4">
        ...
        <div class="ol-card-body">
            <form action="{{ route('admin.admins.teachers.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="d-flex gap-3 flex-wrap flex-md-nowrap">
                    ...
                    <div class="tab-content w-100" id="myv-pills-tabContent">
                        ...
                        <div class="tab-pane fade" id="v-pills-tab4" role="tabpanel" aria-labelledby="v-pills-tab4-tab" tabindex="0">
                            @include('admin.admin.teachers.create_social')
                        </div>
