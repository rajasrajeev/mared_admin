    ...
    <div class="ol-card radius-8px">
        <div class="ol-card-body my-3 py-12px px-20px">
            <div class="d-flex align-items-center justify-content-between gap-3 flex-wrap flex-md-nowrap">
                ...
                <a href="{{ route('admin.admins.teachers.create') }}" class="btn ol-btn-outline-secondary d-flex align-items-center cg-10px">
    ...
    <div class="ol-card p-4">
        <div class="ol-card-body">
            ...
            <div class="row print-d-none mb-3 mt-3 row-gap-3">
                ...
                <div class="col-md-6">
                    <form class="form-inline" action="{{ route('admin.admins.teachers.index') }}" method="get">
                ...
                <div class="col-md-12">
                    @if (count($teacher) > 0)
                        <div class="admin-tInfo-pagi d-flex justify-content-between justify-content-center align-items-center flex-wrap gr-15">
                            <p class="admin-tInfo">
                                {{ get_phrase('Showing') . ' ' . count($teacher) . ' ' . get_phrase('of') . ' ' . $teacher->total() . ' ' . get_phrase('data') }}
                            </p>
                        </div>
                                                ...
                                                <!-- @if (!is_root_admin($row->id)) -->
                                                    <div class="dropdown ol-icon-dropdown ol-icon-dropdown-transparent">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            ...
                                                            <li>
                                                                <a class="dropdown-item" href="{{ route('admin.admins.teachers.edit', ['id' => $row->id]) }}">{{ get_phrase('Edit') }}</a>
                                                            </li>

                                                            <li>
                                                                <a class="dropdown-item" onclick="confirmModal('{{ route('admin.admins.teachers.delete', $row->id) }}')"
